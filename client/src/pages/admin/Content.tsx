...
import { Plus, Sparkles, Trash2, Edit, Eye, EyeOff } from "lucide-react";
          ...
          <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex gap-2 justify-end">
                ...
                <Button type="submit" disabled={createMutation.isPending || updateMutation.isPending} data-testid="button-save-content">
                  {(createMutation.isPending || updateMutation.isPending) ? <Spinner className="h-4 w-4" /> : editingId ? "Update Content" : "Save Content"}
                </Button>
              </div>
            </form>
          </DialogContent>
